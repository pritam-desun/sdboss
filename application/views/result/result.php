                            ...
                            <tr>
                                ...
                                foreach ($result as $key => $r) {
                                    ...
                                    if (empty($game_result)) { ?>
                                        <td><button class="btn btn-success mb-2 add_result" id="add_result" data-id="<?= $r->cat_id ?>" data-prev="<?= $key ?>" data-gcode=<?= $r->gcode ?> data-published_on=<?= date('d/m/Y', strtotime('-1 day')) ?>>Click Result</button></td>
                                    <?php } else {
                                    ?>
                                        <td><button class="btn btn-danger mb-2 edit_result" id="edit_result" data-id="<?= $r->cat_id ?>" data-prev="<?= $key ?>" data-gcode=<?= $r->gcode ?> data-single=<?= $game_result[0]->win_number ?> data-patti=<?= $game_result[1]->win_number ?> <?php if ($key == 0) { ?> data-cp="<?= $game_result[2]->win_number ?>" data-jodi="" ; <?php } else { ?> data-jodi=<?= $game_result[2]->win_number ?> data-cp="<?= $game_result[3]->win_number ?> " <?php } ?> data-published_on="<?= date('d/m/Y', strtotime($game_result[0]->published_on)) ?>">Click
                                                Result</button></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                foreach ($result as $key => $r) {
                                    ...
                                    if (empty($game_result)) { ?>
                                        <td><button class="btn btn-success mb-2 add_result" id="add_result" data-id="<?= $r->cat_id ?>" data-prev=<?= $key ?> data-gcode=<?= $r->gcode ?> data-published_on=<?= date('d/m/Y', strtotime(str_replace('/', '-', date('Y-m-d')))) ?>>Click Result</button></td>
                                    <?php } else {
...
<div class="modal fade login-modal" id="addResultModal" tabindex="-1" role="dialog" aria-labelledby="addNewsModal" aria-hidden="true">
...
<div class="modal fade login-modal" id="editResultModal" tabindex="-1" role="dialog" aria-labelledby="addNewsModal" aria-hidden="true">
