            ...
            <div class="widget-content widget-content-area br-6">
                <form method="POST" action="" enctype="multipart/form-data" autocomplete="off">
                    <div class="form-group">
                        ...
                        <select id="counter_id" class="form-control" onchange="get_assign_category(this.value)" required name="counter_id">
                    ...
                    <div class="form-group">
                        ...
                        <?php foreach ($categories as $key => $category) { ?>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input chkfalse" value="<?= $category->id ?>" id="category_id<?= $category->id ?>" name="category_id[]">
                    ...
                    <button type="submit" class="btn btn-primary mt-3" id="updateBtn">Update</button>
                </form>
            </div>
        </div>
    </div>
