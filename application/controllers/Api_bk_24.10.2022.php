...
class Api extends CI_Controller {
    ...
    public function signup () {
        ...
        $cust_code = 'CUST' . str_pad($id, 6, "0", STR_PAD_LEFT);
        ...
        $this->wallet->add_balance($cust_code, $default_amount);
    ...
    public function settings () {
        $query = $this->db
            ->select(['email', 'whatsapp_number', 'mobile_number', 'min_deposit_amount', 'min_withdraw_amount', 'rules_page_url', 'share_msg', 'game_off', 'game_off_reason', 'game_off_image'])
            ->where(['id' => 1])
            ->get('settings');
